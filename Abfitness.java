 ...
 public static void main(String[] args) throws IOException {
  ...
  //funkar
   ...
   public static void createCourse() throws IOException { // funkar
      ...
      public static void deleteCourse() throws IOException { // Funkar om man inte vill ta bort courses som har coursesessions d� bryts foreign key constraint
         try {
   ...
   public static void bookCourse() throws IOException { //funkar, �ndrat i SQL-s�kning s� att man f�r skriva facility-namn och f�r det utskrivet ist�llet f�r ID
   ...
   public static void memberBookCourse() throws IOException { //funkar, �ndrat i SQL-s�kning s� att man f�r skriva facility-namn och f�r det utskrivet ist�llet f�r ID
